...
namespace NumberRecognizerDesktop
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            //Load data.
            dataSet = DataLoader.LoadDataSetLetters(@"C:\Users\Aleksandra\Documents\GitHub\fonts");
            ...
            neuralNetworks.Add(new NeuralNetworkLetters(0.05, 20));
            neuralNetworks.Add(new NeuralNetworkLetters(0.05, 40));
            neuralNetworks.Add(new NeuralNetworkLetters(0.05, 60));
            neuralNetworks.Add(new NeuralNetworkLetters(0.05, 60));
            neuralNetworks.Add(new NeuralNetworkLetters(0.05, 100));
